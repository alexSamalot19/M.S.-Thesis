      ...
      integer:: tickObs, tickModYes, justatick
      ...
      open(unit=2, file='GClistM32.txt')
      read(2,*)GC
      close(2)
      ...
      !write (*,*) 'station=', station
        tickObs=tickObs+9
        tickModYes=tickModYes+9
        tickModTom=tickModTom+9
        tickyV=tickyV+9
        tickX_M=tickX_M+9
        tickP_M=tickP_M+9
        tickModTom_f=tickModTom_f + 9
        tickBias_Pred=tickBias_Pred+9
