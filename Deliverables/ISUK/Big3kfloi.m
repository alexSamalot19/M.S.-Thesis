% %Stats%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
DRDKalmb=mean(BTM1Kal);
DRDwrfmb=mean(BTwrf);
DRDpKalmb=mean(BTpKal);
DRDsqKalrmse=mean(BTsqM1Kal);
DRDsqwrfrmse=mean(BTsqwrf);
DRDsqpKalrmse=mean(BTsqpKal);

dlmwrite('loikfKalRMSE.txt',DRDsqM1Kal);
dlmwrite('loikfPkalRMSE.txt',DRDsqpKal);
dlmwrite('loikfWRFrmse.txt',DRDsqM1WRF);

dlmwrite('loikfKalBIAS.txt',DRDM1Kal);
dlmwrite('loipkfPkaBIAS.txt',DRDpKal);
dlmwrite('loikfWRFbias.txt',DRDM1WRF);
