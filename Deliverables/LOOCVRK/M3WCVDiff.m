...
% %
% %
% %     %%%%Read Foldering Of Madis vs. Metar
...
% %
% %     %ReadSTffmat.csv
% %     filename = fullfile('F:','Meth34nBase',['BiasBStFE',STstring],'STffmat.csv');
...
% %
% %         SToutName=fullfile('G:','CV62015Cast',Comp,,[filebeg,'HSTn0.txt']);
% %         filebeg  = (FiMetIn(RN,:));
% %         STCVname=[filebeg,'SC24.txt'];
% %         STCVID=fopen(fullfile('CEELab05','storm',STCVname),'r');
% %         timnam = 1;
...
% %     end
% %
% %     %%%Still need to make the FF matrix for the Wind
% %
% %
% %     %%%%
% %
