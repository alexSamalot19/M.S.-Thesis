...
for storm=51%3:stormf;
    fclose('all')
    clearvars -except storm stoArray positive TCHT
    tisUE10=0;
    tisUE30=0;
...
% dlmwrite('StormHT.txt',positive)
% dlmwrite('StormConst.txt',TCHT)
...
% MetarFo='KrInMetHT';
% MadisFo='KrInMadHT';
% AdjFo=['BiasCombOutM3',STstring];
% BySTatFo=['BiasBStM3',STstring];
% 
% 
% FiMetIn = ['20010305';'20031214';'20040701';'20040820';'20040908'; ...
%     '20040917';'20040928';'20041104';'20041130';'20041225';'20050401'; ...
