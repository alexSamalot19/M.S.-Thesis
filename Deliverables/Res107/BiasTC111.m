...
for storm=1:sili;
    ...
    if list(storm,1)>0
        fclose('all')
        clearvars -except storm list sili
        tisUE10=0;
        tisUE30=0;
        %     stoArray=[6,16,29,39,44,57,64,69,81,96,105];
        
        %%%%%%%%%%%%%%%%%%%%%%%%%%%
        RN=list(storm,1);%Rand #
        STstring=num2str(RN);
        string=STstring;
        starTime=RN;
...
disp(storm)
        ...
        if endTime>24
            ...
            for t =1:endTime
                ...
                MPlusID=fopen(fullfile(AdjFo,MetPlus), 'w');
                    ...
                    for compare = 1:sizeYS(1);
                        ...
                        if thresh<1; %do several trials until correct threshold found
                            ...
                            if GCorig(orig,1)==GCcv(compare,orig)
                                ...
                                if takeout>MMswitch
                                    link2{build,place}=MetarFo;
                                else
                                    link2{build,place}=MadisFo;
                                end
                                %<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                                ...
                                if takeout>MMswitch
                                    newST2{build,1}=MetarFo;
                                else
                                    newST2{build,1}=MadisFo;
                                end
                                %<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
%             disp(build)
            ...
            %
            if t==endTime
                save(fullfile(AdjFo,'Elim111.mat'))
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        clearvars -except RN string starTime STstring Tailtest AdjFo ... 
            BySTatFo list
