...
for st=3:35%36:69      %70:109%1:(Stnum-1)
    %     COMP=CompArray(st,:);
    BySTatFo=['WindBStat',num2str(st)];
    BySTW=['loi111',num2str(st),'.mat'];
...
%                 
                ...
                if pkdrivec>0
                    ...
                    Bigtism=Bigtism+1;
                    %KALcompare
                    DRIKALC=dlmread(fullfile(DriveInfo,BySTatFo111,['Kal111FFa', ...
                        lname,'.csv']));
                    DRIPKALC=dlmread(fullfile(DriveInfo,BySTatFo111,['KP111FFa', ...
                        lname,'.csv']));
                    disp(tism)
        disp(st)
