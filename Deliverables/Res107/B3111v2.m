...
% dlmwrite('KalRMSE111v2.txt',DRDsqKal);
% dlmwrite('PkalRMSE111v2.txt',DRDsqpKal);
% dlmwrite('WRFrmse111v2.txt',DRDsqwrf);
% 
% dlmwrite('KalBIAS111v2.txt',DRDKal);
% dlmwrite('PkalBIAS111v2.txt',DRDpKal);
% dlmwrite('WRFbias111v2.txt',DRDwrf);
...
fig = figure;
%Label Comb>>
line1 ='Method 2 KF and RK Estimation of Wind Speed 10% Sample of Storms';
% %<<
