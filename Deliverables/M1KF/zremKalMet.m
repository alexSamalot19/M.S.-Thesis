...
for notu=80:numvals(1)
    ...
    for inner=1:iend
        ...
        CoutName=[filebeg,'MCn0.txt'];
        RoutName=[filebeg,'MRn0.txt'];
        SToutName=[filebeg,'MSTn0.txt'];
        FFoutName=[filebeg,'MFFn0.txt'];
        
        
        ST24ID = fopen(fullfile('wfMFFST',SToutName), 'w');
        C24ID = fopen(fullfile('wfMCR',CoutName), 'w');
        R24ID = fopen(fullfile('wfMCR',RoutName),'w');
        FF24ID=fopen(fullfile('wfMFFST',FFoutName),'w');
