      ...
      integer:: dim, tickKalman, tickKalman_resYes
      integer:: tickKalman_resTom, tickModTom_f
      integer:: tickObs, tickModYes
      integer:: station, tickModTom, tickyV, tickX_m, tickP_M
      integer:: tickX, tickP,i,j,k,m,n,Status,hours 
      ...
      !station = 1 
        DO station=38151,numStat

      !write (*,*) 'station=', station
        tickObs=tickObs+8
        tickModYes=tickModYes+8
        tickModTom=tickModTom+8
        tickyV=tickyV+8
        tickX_M=tickX_M+8
        tickP_M=tickP_M+8
        tickModTom_f=tickModTom_f + 8
